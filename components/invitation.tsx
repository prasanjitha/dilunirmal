  ...
  return (
    <div className="min-h-screen bg-white font-serif">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <div className="relative z-10 text-center px-4">
            ...
            <p
              className="text-xl md:text-2xl text-text-black italic mb-6"
              style={{ fontFamily: '"Dancing Script", cursive' }}
            >
              Invite you to witness the beginning of their forever
            </p>
            <p
              className="text-lg md:text-xl text-text-black mb-8"
              style={{ fontFamily: '"Dancing Script", cursive' }}
            >
        ...
        <AudioPlayer />
        <div
          className="absolute bottom-[-6] w-full md:!h-10 bg-white z-20"
          style={{
      ...
      <section className="py-16 px-4 bg-white text-center">
        <div className="max-w-3xl mx-auto" style={{ fontFamily: '"Dancing Script", cursive' }}>
          <p
          ...
          >
            ...
            <span className="text-yellow-600">
              Nirmal, son of Mr. & Mrs. Sayakkarage
            </span>
            <br />
            and
            <br />
            <span className="text-yellow-600">
              Madhuri, daughter of Mr. & Mrs. Nimalasiri
            </span>
            <br />
            joyfully invite you to celebrate the beginning of their new life
            together.
            <br />

    ...
    <div className="min-h-screen bg-white font-serif">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <img
          ...
          alt="Wedding background"
          className="absolute inset-0 w-full h-full object-cover z-0 animate-zoomSlow animate-pulse-zoom"
        />
        <div className="relative z-10 text-center px-4">
          <div className="relative z-10 text-center px-4">
            <h1 className="text-5xl md:text-7xl font-Satisfy text-yellow-400 mb-6">
              Nirmal & Madhuri
            </h1>
            <p
              className="text-xl md:text-2xl text-yellow-500 italic mb-6"
              style={{ fontFamily: '"Dancing Script", cursive' }}
            >
              Invite you to witness the beginning of their forever
            </p>
            <p
              className="text-lg md:text-xl text-yellow-500 mb-8"
              style={{ fontFamily: '"Dancing Script", cursive' }}
            >
              With grateful hearts, we celebrate our love with you
            </p>
          </div>
        </div>
        {/* Wave effect at bottom */}
        <div
          className="absolute bottom-[-6] w-full h-16 bg-white z-20"
          style={{
      ...
      <section className="py-16 px-4 bg-white text-center">
        <div className="max-w-3xl mx-auto">
          <p className="text-lg md:text-xl text-gray-800 mb-6">
            Daughter of Mr. & Mrs. Malani and son of Mr. & Mrs. Gamage, request
